...
offckb deploy --network devnet --target <contract-binary-path> --output /Users/ebube/Desktop/Personal/ckb-starter/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /Users/ebube/Desktop/Personal/ckb-starter/deployment
```
